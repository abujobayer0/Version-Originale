...
const Jersey = () => {
  ...
  const filterProducts = (products) => {
    return products.filter((product) => product.category === "jersey");
  };
  ...
  useEffect(() => {
    if (products && !isLoading) {
      setProductToShow(
        products.filter((curElem) => curElem.category === "Jersey")
      );
    }
  }, [products]);
  ...
  return (
    <div className=" px-6 lg:px-[6rem] xl:px-[4rem] pt-[2.13rem] pb-[3rem] lg:pt-[5.19rem] lg:pb-[4.35rem]">
      <MobileFilter
