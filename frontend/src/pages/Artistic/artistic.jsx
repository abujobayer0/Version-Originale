...
const Artestic = () => {
  ...
  const filterProducts = (products) => {
    return products.filter((product) => product.subCategoryb === "Artistic");
  };
  ...
  useEffect(() => {
    if (products && !isLoading) {
      setProductToShow(
        products.filter((curElem) => curElem.subCategory === "Artistic")
      );
    }
  }, [products]);
  ...
  return (
    <section>
      <div className="container px-6 lg:px-[4rem] pt-[2.13rem] pb-[3rem] lg:pt-[5.19rem] lg:pb-[4.35rem]">
        <MobileFilter
