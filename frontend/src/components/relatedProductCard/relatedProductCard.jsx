...
const RelatedProductCard = (curElem) => {
  ...
  return (
    <>
      <Link to={`/${countryRoute}/product/${_id}`}>
        <div className="group border-[1.76px] border-[#000]/20 my-10 flex w-full max-w-xs flex-col overflow-hidden  shadow-md">
          <a
          ...
          >
            ...
            {stock === "unavailable" && (
              <div className="bg-red-500 text-black font-bold py-1 px-2  absolute top-2 right-2">
                Stock Out
              </div>
            )}
          </a>
          <div className="mt-4 px-5 pb-0">
            <a href="#">
              <h3 className="text-[#000] text-[.65rem] sm:text-[.88rem] font-bold leading-[122.5%] tracking-[0.009rem] line-clamp-1 euroWide ">
                {productName}{" "}
              </h3>
            </a>
            <div className="mt-2 mb-5 flex relative items-center justify-between">
              <p className="flex items-center gap-2 text-[#000] text-opacity-70  text-[.75rem] sm:text-[.70rem] font-bold leading-[122.5%] tracking-[0.009rem] euroWide mt-[0.56rem] ">
                {bdPriceSale !== 0 && dubaiPrice !== 0 && (
                  <p className="text-[#000] text-opacity-70  text-[.65rem] sm:text-[.70rem] font-bold leading-[122.5%] tracking-[0.009rem] euroWide ">
                    {selectedCurrency === "BDT" ? (
                      <p className="text-[#000] whitespace-nowrap text-opacity-70  text-[.65rem] sm:text-[.70rem] font-bold leading-[122.5%] tracking-[0.009rem] euroWide ">
                        BDT {bdPriceSale}
                      </p>
                    ) : (
                      <p className="text-[#000] whitespace-nowrap text-opacity-70  text-[.65rem] sm:text-[.70rem] font-bold leading-[122.5%] tracking-[0.009rem] euroWide  ">
                ...
                <p
                  className={`text-[#000] text-opacity-70 whitespace-nowrap text-[.65rem] sm:text-[.70rem] font-bold leading-[122.5%] tracking-[0.009rem] euroWide  ${
